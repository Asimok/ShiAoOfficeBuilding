...
public class Usual_Per_Warn_Adapter extends BaseAdapter {
    public int count;
    protected Context context;
    protected LayoutInflater inflater;
    protected int resource;
    protected ArrayList<Usual_Per_Warning_Info> data;
    public Usual_Per_Warn_Adapter(Context context, int count, ArrayList<Usual_Per_Warning_Info> data){
