...
public class Elec_Warn_Adapter extends BaseAdapter {
    public int count;
    protected Context context;
    protected LayoutInflater inflater;
    protected int resource;
    protected ArrayList<Elec_Warn_info> data;
    public Elec_Warn_Adapter(Context context,  int count,ArrayList<Elec_Warn_info> data){
